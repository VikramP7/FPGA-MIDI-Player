...
HD_PWD='C:/Users/vikra/Documents/SyncedProjects/FPGA-MIDI-Player/MIDI-Player-and-ADC/MIDI-Player-and-ADC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log music_adc_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source music_adc_top_level.tcl
