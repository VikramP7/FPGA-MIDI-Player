...
set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports r2r_adc_comp];#Sch name = XA2_P #[get_ports {JXADC[1]}]
#set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {JXADC[2]}];#Sch name = XA3_P [get_ports {JXADC[2]}]
...
set_property -dict { PACKAGE_PIN M3   IOSTANDARD LVCMOS33 } [get_ports pwm_adc_comp];#Sch name = XA2_N # {JXADC[5]}
