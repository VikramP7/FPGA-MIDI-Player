...
HD_PWD='C:/Users/vikra/Documents/SyncedProjects/FPGA-MIDI-Player/MIDI-Player-and-ADC/MIDI-Player-and-ADC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log music_adc_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source music_adc_top_level.tcl -notrace
