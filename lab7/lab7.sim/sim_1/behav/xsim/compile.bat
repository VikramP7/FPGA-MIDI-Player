...
REM
REM Generated by Vivado on Wed Nov 19 12:42:42 -0700 2025
...
echo "xvlog --incr --relax -L uvm -prj r2r_adc_sar_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj r2r_adc_sar_tb_vlog.prj -log xvlog.log
